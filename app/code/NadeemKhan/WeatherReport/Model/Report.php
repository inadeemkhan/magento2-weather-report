...
use NadeemKhan\WeatherReport\Api\Data\ReportInterface;
use NadeemKhan\WeatherReport\Api\Data\ReportInterfaceFactory;
use NadeemKhan\WeatherReport\Model\Http\Client;
use NadeemKhan\WeatherReport\Api\ReportRepositoryInterface;
...
class Report extends \Magento\Framework\Model\AbstractModel
{
    ...
    protected $_eventPrefix = 'nadeemkhan_weatherreport_report';
    ...
    public function __construct(
        ...
        \NadeemKhan\WeatherReport\Model\ResourceModel\Report $resource,
        \NadeemKhan\WeatherReport\Model\ResourceModel\Report\Collection $resourceCollection,
        Client $httpClient,
    ...
    public function getReportData($request)
    {
        if (
            ...
            $fromFormatted = date('Y-m-d H:i:s', strtotime($from));
            $toFormatted = date('Y-m-d 23:59:59', strtotime($to));
