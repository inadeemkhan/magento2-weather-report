...
namespace NadeemKhan\WeatherReport\Controller\City;

use Magento\Framework\Data\Form\FormKey\Validator;
use Magento\Framework\App\Action\Context;
use Magento\Framework\View\Result\PageFactory;
use NadeemKhan\WeatherReport\Model\GeneratePdfFactory;
use NadeemKhan\WeatherReport\Model\ReportFactory;

/**
 * Class Report
 * @package NadeemKhan\WeatherReport\Controller\City
 */
class Report extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->getParam('generate')) {
            ...
            if(is_array($reportData) && is_array($reportData) && count($reportData) > 0) {
